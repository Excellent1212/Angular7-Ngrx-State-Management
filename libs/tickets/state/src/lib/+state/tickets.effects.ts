...
export class TicketsEffects {
  ...
  // Update title every time route or context changes, pulling current tickets from the store.
  @Effect({dispatch: false})
  updateTitle$ = combineLatest(this.actions$.pipe(ofType(ROUTER_NAVIGATION)), this.store.pipe(select(TicketsQuery.getTickets)),
